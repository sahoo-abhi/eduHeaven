...
const ViewReferenceBooks = () => {
  ...
  const fetchFiles = async () => {
    ...
    try {
      ...
      const storedFiles = localStorage.getItem(`refbooks_${subject}`);
  ...
  const handleDelete = async (fileId) => {
    if (!window.confirm('Are you sure you want to delete this reference book?')) return;
  ...
  const handleUploadNew = () => {
    navigate(`/upload-reference-books/${subject}`);
  };

  const handleBackToSubjects = () => {
    navigate('/reference-books');
  };
        ...
        <main className="dashboard-main" style={{ paddingTop: "4rem" }}>
          <div className="dashboard-container">
            ...
            >
              ...
              >
                {formatSubjectName(subject)} - Reference Books and Textbooks
              </motion.div>
            </motion.div>
            ...
            >
              {loading ? (
                <div className="flex items-center justify-center py-12">
                  ...
                  <span className="ml-3 text-white/80">Loading reference books...</span>
                </div>
              ) : files.length === 0 ? (
                <motion.div 
                ...
                >
                  <div className="dashboard-card p-8">
                    ...
                    <p className="text-white/60 mb-6">
                      No reference books have been uploaded for {formatSubjectName(subject)} yet.
                    </p>
                    <motion.button
            ...
            >
              <div className="dashboard-footer-content">
                ...
                >
                  Building a comprehensive library of reference books for {formatSubjectName(subject)}
                </motion.span>
...
export default ViewReferenceBooks;
